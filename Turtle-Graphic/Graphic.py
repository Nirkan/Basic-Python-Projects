...
def draw(l):   # recursive function taking length 'l' as argument
	if (l < 10):
		...
		roo.forward(l)         # moving turtle forward by '1'
		roo.left(30)           # moving the turtle 30 degrees towards left
		draw(3 * l/4)          # drawing a fractal on the left of the turtle object.
		roo.right(60)          # moving the turtle 60 degrees towrds right
